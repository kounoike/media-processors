...
export default [
  {
    input: "src/presenter_overlay.ts",
    plugins: [
    ...
    output: {
      sourcemap: false,
      file: "./dist/presenter_overlay.js",
      format: "umd",
      name: "Shiguredo",
      extend: true,
      banner: banner,
  ...
  {
    input: "src/presenter_overlay.ts",
    plugins: [typescript({ module: "esnext" }), commonjs(), resolve(), mediapipe_workaround()],
    output: {
      sourcemap: false,
      file: "./dist/presenter_overlay.mjs",
      format: "module",
      name: "Shiguredo",
      extend: true,
      banner: banner,
